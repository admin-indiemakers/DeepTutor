  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      >
        ...
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">Drop Semester</h1>
      </motion.div>
      ...
      >
        ...
        <h2 className="text-lg font-bold text-slate-900 mb-2">Drop Semester Workspace</h2>
        <p className="text-slate-500 text-sm max-w-md mx-auto leading-relaxed">
          Submit official drop requests, view academic withdrawal policies, and calculate semester clearance fees. 
