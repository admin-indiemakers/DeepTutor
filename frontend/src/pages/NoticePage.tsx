  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      >
        ...
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">Academic Notices</h1>
      </motion.div>
      ...
      >
        ...
        <h2 className="text-lg font-bold text-slate-900 mb-2">Notice Board</h2>
        <p className="text-slate-500 text-sm max-w-md mx-auto leading-relaxed">
          Read campus announcements, department news, exam schedules, and holiday bulletins. 
