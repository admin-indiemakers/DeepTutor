  ...
  return (
    <div className="p-6 max-w-4xl mx-auto space-y-6">
      ...
      >
        ...
        <h1 className="text-2xl font-black text-slate-900 tracking-tight">Payment Info</h1>
      </motion.div>
      ...
      >
        ...
        <h2 className="text-lg font-bold text-slate-900 mb-2">Student Billing & Payments</h2>
        <p className="text-slate-500 text-sm max-w-md mx-auto leading-relaxed">
          Manage your tuition details, pending installments, and historical payment receipts here. 
